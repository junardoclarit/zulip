        ...
        e('./v3'),
          (n.Signers.V3Https = i(n.Signers.V3, {
            authorization: function(e) {
              return (
                'AWS3-HTTPS AWSAccessKeyId=' + e.accessKeyId + ',Algorithm=HmacSHA256,Signature=' + this.signature(e)
              );
            },
          ...
          (n.Service = s({
            ...
            retryableError: function(e) {
              return (
                ...
                (!!this.networkingError(e) ||
                  (!!this.expiredCredentialsError(e) || (!!this.throttledError(e) || e.statusCode >= 500)))
              );
            },
            ...
            n.util.update(n.Service, {
              ...
              defineService: function(e, t, r) {
                ...
                if (
                  (n.SequentialExecutor.call(this.prototype), !this.prototype.publisher && n.util.clientSideMonitoring)
                ) {
            ...
            if (n && Object.prototype.hasOwnProperty.call(c.rules, n)) {
              ...
              return (
                ...
                e.config.useDualstack &&
                  ...
                  ((s = u.copy(s)), (s.endpoint = '{service}.dualstack.{region}.amazonaws.com')),
          ...
          (c.setupStates = function() {
            ...
            (n.Request = o({
                      ...
                      var l = function() {
                          u && c !== a
                            ? i.emit(
                                'error',
                                n.util.error(
                                  new Error('Stream content length mismatch. Received ' + c + ' of ' + a + ' bytes.'),
              ...
              presign: function(e, t) {
                return (
                  t || 'function' != typeof e || ((t = e), (e = null)), new n.Signers.Presign().sign(this.toGet(), e, t)
                );
              },
              isPresigned: function() {
        ...
        function n(e, t) {
          ...
          (e = e || {}),
            ...
            h(this, 'className', function() {
              ...
              return t
                ? ((t = t.replace(/^Amazon|AWS\s*|\(.*|\s+|\W+/g, '')), 'ElasticLoadBalancing' === t && (t = 'ELB'), t)
                : null;
            }),
            l(
              this,
            ...
            t.documentation &&
              (l(this, 'documentation', e.documentation), l(this, 'documentationUrl', e.documentationUrl));
        }
        var i = e('./collection'),
          o = e('./operation'),
          s = e('./shape'),
      ...
      function(e, t, r) {
        function n(e, t, r) {
          ...
          (r = r || {}),
            ...
            r.documentation &&
              (a(this, 'documentation', t.documentation), a(this, 'documentationUrl', t.documentationUrl)),
    ...
    61: [
      function(e, t, r) {
        ...
        (n.Endpoint = i({
          constructor: function(e, t) {
            if (
              (n.util.hideProperties(this, ['slashes', 'auth', 'hash', 'search', 'query']), void 0 === e || null === e)
            )
                ...
                t('SEND', 'send', function(e, t) {
                  function r(r) {
                    ...
                    r.on('headers', function(n, s, a) {
                      ...
                      r.on('end', function() {
                        if (!n || !n.didCallback) {
                          if (2 === i.HttpClient.streamsApiVersion && u.hasEventOutput && o.successfulResponse(e))
                            return;
    ...
    88: [
      function(e, t, r) {
        ...
        (n.SequentialExecutor = n.util.inherit({
          ...
          on: function(e, t, r) {
            return (
              this._events[e] ? (r ? this._events[e].unshift(t) : this._events[e].push(t)) : (this._events[e] = [t]),
              this
            );
          },
        ...
        function o(e) {
          ...
          t.Errors && (t = t.Errors),
            ...
            t.Code
              ...
              : (e.error = u.error(new Error(), { code: e.httpResponse.statusCode, message: null }));
        }
        function s(e) {
          c.extractData(e);
          var t,
      ...
      function(e, t, r) {
        ...
        function a(e) {
          ...
          if (i.payload) {
            ...
            if (o.isEventStream)
              (t = new p()),
                (e.data[payload] = u.createEventStream(
        ...
        function i(e) {
          ...
          t.requestId && !e.requestId && (e.requestId = t.requestId),
            ...
            t.Code
              ...
              : (e.error = a.error(new Error(), { code: e.httpResponse.statusCode, message: null }));
        }
        function o(e) {
          var t = e.request,
      ...
      function(e, t, r) {
        ...
        function o(e, t, r) {
          (t = t || {}),
            ...
            t.documentation &&
              (n(this, 'documentation', e.documentation), n(this, 'documentationUrl', e.documentationUrl)),
          ...
          (o.create = function(e, t, r) {
            ...
            e.type ||
              (e.members
                ...
                : (e.type = 'string'));
            var a = e.type;
            if ((o.normalizedTypes[e.type] && (e.type = o.normalizedTypes[e.type]), o.types[e.type]))
        ...
        function i(e) {
          ...
          if (
            ...
            try {
              ...
              (n.__type || n.code) && (t.code = (n.__type || n.code).split('#').pop()),
      ...
      function(e, t, r) {
        ...
        function a(e) {
          ...
          u.arrayEach(t, function(e) {
            ...
            if (!r.test(e))
              throw c.util.error(new Error(), { code: 'ValidationError', message: e + ' is not hostname compatible.' });
          });
        }
        var u = e('../util'),
          c = e('../core');
        ...
        (function(r) {
          ...
          function a(e, t) {
            ...
            if (p && 1 === p.length && '' === p[0].Address)
              return g[h] || (g[h] = []), void g[h].push({ request: e, callback: t });
          ...
          function p(e) {
            ...
            try {
              i = d.util.iniLoader
                ? d.util.iniLoader.loadFrom({ isConfig: !0, filename: r.env[d.util.sharedConfigFileEnv] })
                : {};
            } catch (e) {}
            ...
            o = {
              ...
              getProfilesFromSharedConfig: function(e, t) {
                ...
                if (r.env[o.configOptInEnv])
                  var i = e.loadFrom({ isConfig: !0, filename: r.env[o.sharedConfigFileEnv] });
                for (
                  var s = e.loadFrom({ filename: t || (r.env[o.configOptInEnv] && r.env[o.sharedCredentialsFileEnv]) }),
                    a = 0,
                    u = Object.keys(i);
                  a < u.length;
                  a++
      ...
      function(e, t, r) {
        ...
        (n.Config = n.util.inherit({
          ...
          extractCredentials: function(e) {
            return (
              e.accessKeyId && e.secretAccessKey && ((e = n.util.copy(e)), (e.credentials = new n.Credentials(e))), e
            );
          },
      ...
      function(e, t, r) {
        ...
        (n.Credentials = n.util.inherit({
          ...
          needsRefresh: function() {
            ...
            return (
              !!(this.expireTime && t > this.expireTime) || (this.expired || !this.accessKeyId || !this.secretAccessKey)
            );
          },
          get: function(e) {
            var t = this;
        ...
        (function(t, n) {
          ...
          function u(e, t, n) {
            ...
            if (
              ...
              return w[0] + g + w[1];
            if (n < 0)
              return _(t) ? e.stylize(RegExp.prototype.toString.call(t), 'regexp') : e.stylize('[Object]', 'special');
            e.seen.push(t);
            var E;
            return (
              (E = y
            ...
            tokenize: function(e) {
              ...
              for (var r, n, i; this._current < e.length; )
                if (s(e[this._current]))
                  ...
                  t.push({ type: x[e[this._current]], value: e[this._current], start: this._current }), this._current++;
          ...
          (T.EOF = 0),
            ...
            (l.prototype = {
                ...
                switch (e) {
                  ...
                  case 'Filter':
                    ...
                    return (
                      ...
                      (r =
                        'Flatten' === this._lookahead(0) ? { type: 'Identity' } : this._parseProjectionRHS(T.Filter)),
              ...
              _parseMultiselectList: function() {
                for (var e = []; 'Rbracket' !== this._lookahead(0); ) {
                  ...
                  if (
                    (e.push(t),
                    'Comma' === this._lookahead(0) && (this._match('Comma'), 'Rbracket' === this._lookahead(0)))
                  )
            ...
            (p.prototype = {
              ...
              _validateArgs: function(e, t, r) {
                ...
                if (r[r.length - 1].variadic) {
                  if (t.length < r.length)
                    throw ((n = 1 === r.length ? ' argument' : ' arguments'),
                    new Error(
              ...
              _functionMaxBy: function(e) {
                for (
                  var t, r, n = e[1], i = e[0], o = this.createKeyFunction(n, [g, b]), s = -1 / 0, a = 0;
                  a < i.length;
                  a++
                )
                  (r = o(i[a])) > s && ((s = r), (t = i[a]));
              ...
              t.createClients(),
                t.masterCredentials.get(function() {
                  (t.service.config.credentials = t.masterCredentials),
                    (t.params.RoleArn ? t.service.assumeRole : t.service.getSessionToken).call(t.service, function(
                      r,
                      n
                    ) {
        ...
        function(e, t, r) {
          ...
          (n.prototype.parse = function(e, t, r) {
            ...
            if (!S[i] && (s || (i && !C[i]))) {
              ...
              if (
                (this.hostname.length > 255 ? (this.hostname = '') : (this.hostname = this.hostname.toLowerCase()), !m)
              ) {
              ...
              (this.host = M + D),
                (this.href += this.host),
                m &&
                  ((this.hostname = this.hostname.substr(1, this.hostname.length - 2)), '/' !== n[0] && (n = '/' + n));
            }
            if (!_[o])
            ...
            !(function(n) {
              ...
              function u(e) {
                return o(e, function(e) {
                  var t = '';
                  return (
                    e > 65535 && ((e -= 65536), (t += N(((e >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
                    (t += N(e))
                  );
                }).join('');
              }
                  ...
                  for (g = n + 1, c - t > U((E - r) / g) && i('overflow'), r += (c - t) * g, t = c, u = 0; u < v; ++u)
                    if (((m = e[u]), m < t && ++r > E && i('overflow'), m == t)) {
                      for (p = r, f = _; (d = f <= s ? S : f >= s + C ? C : f - s), !(p < d); f += _)
                        (b = p - d), (y = _ - d), w.push(N(l(d + (b % y), 0))), (p = U(b / y));
      ...
      3: [
        function(e, t, r) {
          (function(t, n) {
            ...
            function c(e, t) {
              if ((a(t), (e = o(e, t < 0 ? 0 : 0 | d(t))), !n.TYPED_ARRAY_SUPPORT))
                for (var r = 0; r < t; ++r) e[r] = 0;
              return e;
            }
            function l(e, t, r) {
              if ((('string' == typeof r && '' !== r) || (r = 'utf8'), !n.isEncoding(r)))
            ...
            function p(e, t, r, i) {
              ...
              return (
                ...
                n.TYPED_ARRAY_SUPPORT ? ((e = t), (e.__proto__ = n.prototype)) : (e = h(e, t)),
                e
              );
            }
            function f(e, t) {
              ...
              if (t) {
                if (('undefined' != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer) || 'length' in t)
                  return 'number' != typeof t.length || G(t.length) ? o(e, 0) : h(e, t);
            ...
            function b(e, t, r, i, o) {
              ...
              if (('string' == typeof t && (t = n.from(t, i)), n.isBuffer(t)))
                return 0 === t.length ? -1 : w(e, t, r, i, o);
              if ('number' == typeof t)
                return (
                  (t &= 255),
                  n.TYPED_ARRAY_SUPPORT && 'function' == typeof Uint8Array.prototype.indexOf
                    ? o
            ...
            function j(e, t, r, n, i) {
              return (
                i || M(e, t, r, 4, 3.4028234663852886e38, -3.4028234663852886e38), $.write(e, t, r, n, 23, 4), r + 4
              );
            }
            function B(e, t, r, n, i) {
              return (
                i || M(e, t, r, 8, 1.7976931348623157e308, -1.7976931348623157e308), $.write(e, t, r, n, 52, 8), r + 8
              );
            }
            function F(e) {
            ...
            (r.Buffer = n),
              ...
              n.TYPED_ARRAY_SUPPORT &&
                ...
                'undefined' != typeof Symbol &&
                  Symbol.species &&
                  n[Symbol.species] === n &&
                  Object.defineProperty(n, Symbol.species, { value: null, configurable: !0 })),
              ...
              (n.prototype.compare = function(e, t, r, i, o) {
                ...
                for (
                  var s = o - i, a = r - t, u = Math.min(s, a), c = this.slice(i, o), l = e.slice(t, r), h = 0;
                  h < u;
                  ++h
                )
                  if (c[h] !== l[h]) {
          ...
          function c(e) {
            ...
            return (
              1 === n
                ...
                : 2 === n &&
                  ((t = (e[r - 2] << 8) + e[r - 1]), i.push(l[t >> 10] + l[(t >> 4) & 63] + l[(t << 2) & 63] + '=')),
              i.join('')
            );
          }
...
(AWS.apiLoader.services.cognitoidentity = {}),
  ...
  (_xamzrequire = (function e(t, n, r) {
    ...
    for (var o = 'function' == typeof _xamzrequire && _xamzrequire, u = 0; u < r.length; u++) i(r[u]);
    return i;
  })(
    {
      93: [
...
AWS.apiLoader.services.cognitoidentity['2014-06-30'] = {
  ...
  operations: {
    ...
    DeleteIdentityPool: { input: { type: 'structure', required: ['IdentityPoolId'], members: { IdentityPoolId: {} } } },
    DescribeIdentity: {
    ...
    GetCredentialsForIdentity: {
      ...
      output: {
        ...
        members: {
          ...
          Credentials: {
            type: 'structure',
            members: { AccessKeyId: {}, SecretKey: {}, SessionToken: {}, Expiration: { type: 'timestamp' } }
          }
        }
      }
    },
    ...
    GetOpenIdToken: {
      input: { type: 'structure', required: ['IdentityId'], members: { IdentityId: {}, Logins: { shape: 'S10' } } },
    ...
    GetOpenIdTokenForDeveloperIdentity: {
      input: {
        ...
        members: { IdentityPoolId: {}, IdentityId: {}, Logins: { shape: 'S10' }, TokenDuration: { type: 'long' } }
      },
      output: { type: 'structure', members: { IdentityId: {}, Token: {} } }
    },
    ListIdentities: {
      ...
      output: {
        type: 'structure',
        members: { IdentityPoolId: {}, Identities: { type: 'list', member: { shape: 'Sv' } }, NextToken: {} }
      }
    },
    ListIdentityPools: {
      input: {
    ...
    LookupDeveloperIdentity: {
      ...
      output: {
        type: 'structure',
        members: { IdentityId: {}, DeveloperUserIdentifierList: { type: 'list', member: {} }, NextToken: {} }
      }
    },
    ...
    UnlinkDeveloperIdentity: {
      input: {
        ...
        members: { IdentityId: {}, IdentityPoolId: {}, DeveloperProviderName: {}, DeveloperUserIdentifier: {} }
      }
    },
    UnlinkIdentity: {
      input: {
...
(AWS.apiLoader.services.amplify = {}), (AWS.Amplify = AWS.Service.defineService('amplify', ['2017-07-25']));
AWS.apiLoader.services.amplify['2017-07-25'] = {
  ...
  operations: {
    CreateApp: {
      ...
      output: { type: 'structure', required: ['app'], members: { app: { shape: 'Sz' } } }
    },
    CreateBackendEnvironment: {
      ...
      output: { type: 'structure', required: ['backendEnvironment'], members: { backendEnvironment: { shape: 'S1e' } } }
    },
    CreateBranch: {
      ...
      output: { type: 'structure', required: ['branch'], members: { branch: { shape: 'S1l' } } }
    },
    CreateDeployment: {
      http: { requestUri: '/apps/{appId}/branches/{branchName}/deployments' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName'],
        members: {
      ...
      output: {
        ...
        members: { jobId: {}, fileUploadUrls: { type: 'map', key: {}, value: {} }, zipUploadUrl: {} }
      }
    },
    CreateDomainAssociation: {
      ...
      output: { type: 'structure', required: ['domainAssociation'], members: { domainAssociation: { shape: 'S28' } } }
    },
    CreateWebhook: {
      ...
      input: {
        type: 'structure',
        required: ['appId', 'branchName'],
        members: { appId: { location: 'uri', locationName: 'appId' }, branchName: {}, description: {} }
      },
      output: { type: 'structure', required: ['webhook'], members: { webhook: { shape: 'S2j' } } }
    },
    DeleteApp: {
      http: { method: 'DELETE', requestUri: '/apps/{appId}' },
      input: { type: 'structure', required: ['appId'], members: { appId: { location: 'uri', locationName: 'appId' } } },
      output: { type: 'structure', required: ['app'], members: { app: { shape: 'Sz' } } }
    },
    DeleteBackendEnvironment: {
      http: { method: 'DELETE', requestUri: '/apps/{appId}/backendenvironments/{environmentName}' },
      input: {
        type: 'structure',
        required: ['appId', 'environmentName'],
        members: {
          appId: { location: 'uri', locationName: 'appId' },
          environmentName: { location: 'uri', locationName: 'environmentName' }
        }
      },
      output: { type: 'structure', required: ['backendEnvironment'], members: { backendEnvironment: { shape: 'S1e' } } }
    },
    DeleteBranch: {
      http: { method: 'DELETE', requestUri: '/apps/{appId}/branches/{branchName}' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName'],
        members: {
    ...
    DeleteDomainAssociation: {
      http: { method: 'DELETE', requestUri: '/apps/{appId}/domains/{domainName}' },
      input: {
        type: 'structure',
    ...
    DeleteJob: {
      http: { method: 'DELETE', requestUri: '/apps/{appId}/branches/{branchName}/jobs/{jobId}' },
      input: {
        type: 'structure',
      ...
      output: { type: 'structure', required: ['jobSummary'], members: { jobSummary: { shape: 'S2x' } } }
    },
    DeleteWebhook: {
      ...
      input: {
        type: 'structure',
        required: ['webhookId'],
        members: { webhookId: { location: 'uri', locationName: 'webhookId' } }
      },
      output: { type: 'structure', required: ['webhook'], members: { webhook: { shape: 'S2j' } } }
    },
    GenerateAccessLogs: {
    ...
    GetArtifactUrl: {
      ...
      input: {
        type: 'structure',
        required: ['artifactId'],
        members: { artifactId: { location: 'uri', locationName: 'artifactId' } }
      },
      output: {
        type: 'structure',
    ...
    GetBackendEnvironment: {
      http: { method: 'GET', requestUri: '/apps/{appId}/backendenvironments/{environmentName}' },
      input: {
        type: 'structure',
        required: ['appId', 'environmentName'],
        members: {
    ...
    GetBranch: {
      http: { method: 'GET', requestUri: '/apps/{appId}/branches/{branchName}' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName'],
        members: {
    ...
    GetDomainAssociation: {
      http: { method: 'GET', requestUri: '/apps/{appId}/domains/{domainName}' },
      input: {
        type: 'structure',
        required: ['appId', 'domainName'],
        members: {
    ...
    GetJob: {
      http: { method: 'GET', requestUri: '/apps/{appId}/branches/{branchName}/jobs/{jobId}' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName', 'jobId'],
        members: {
    ...
    ListApps: {
      ...
      output: {
        type: 'structure',
        required: ['apps'],
        members: { apps: { type: 'list', member: { shape: 'Sz' } }, nextToken: {} }
      }
    },
    ListArtifacts: {
      http: { method: 'GET', requestUri: '/apps/{appId}/branches/{branchName}/jobs/{jobId}/artifacts' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName', 'jobId'],
        members: {
    ...
    ListBackendEnvironments: {
      http: { method: 'GET', requestUri: '/apps/{appId}/backendenvironments' },
      input: {
        type: 'structure',
        required: ['appId'],
        members: {
      ...
      output: {
        ...
        members: { backendEnvironments: { type: 'list', member: { shape: 'S1e' } }, nextToken: {} }
      }
    },
    ListBranches: {
      ...
      output: {
        type: 'structure',
        required: ['branches'],
        members: { branches: { type: 'list', member: { shape: 'S1l' } }, nextToken: {} }
      }
    },
    ListDomainAssociations: {
      ...
      output: {
        ...
        members: { domainAssociations: { type: 'list', member: { shape: 'S28' } }, nextToken: {} }
      }
    },
    ListJobs: {
      http: { method: 'GET', requestUri: '/apps/{appId}/branches/{branchName}/jobs' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName'],
        members: {
      ...
      output: {
        ...
        members: { jobSummaries: { type: 'list', member: { shape: 'S2x' } }, nextToken: {} }
      }
    },
    ListTagsForResource: {
      ...
      input: {
        ...
        members: { resourceArn: { location: 'uri', locationName: 'resourceArn' } }
      },
    ...
    ListWebhooks: {
      ...
      output: {
        type: 'structure',
        required: ['webhooks'],
        members: { webhooks: { type: 'list', member: { shape: 'S2j' } }, nextToken: {} }
      }
    },
    StartDeployment: {
      http: { requestUri: '/apps/{appId}/branches/{branchName}/deployments/start' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName'],
        members: {
    ...
    StopJob: {
      http: { method: 'DELETE', requestUri: '/apps/{appId}/branches/{branchName}/jobs/{jobId}/stop' },
      input: {
        type: 'structure',
        required: ['appId', 'branchName', 'jobId'],
        members: {
    ...
    TagResource: {
      ...
      input: {
        type: 'structure',
        required: ['resourceArn', 'tags'],
        members: { resourceArn: { location: 'uri', locationName: 'resourceArn' }, tags: { shape: 'Sl' } }
      },
      output: { type: 'structure', members: {} }
    },
    UntagResource: {
      ...
      input: {
        ...
        members: {
          ...
          tagKeys: { location: 'querystring', locationName: 'tagKeys', type: 'list', member: {} }
        }
      },
      output: { type: 'structure', members: {} }
    },
    ...
    UpdateWebhook: {
      ...
      input: {
        type: 'structure',
        required: ['webhookId'],
        members: { webhookId: { location: 'uri', locationName: 'webhookId' }, branchName: {}, description: {} }
      },
      output: { type: 'structure', required: ['webhook'], members: { webhook: { shape: 'S2j' } } }
    }
  },
  shapes: {
    ...
    Sz: {
      ...
      members: {
        ...
        productionBranch: {
          type: 'structure',
          members: { lastDeployTime: { type: 'timestamp' }, status: {}, thumbnailUrl: {}, branchName: {} }
        },
        buildSpec: {},
        enableAutoBranchCreation: { type: 'boolean' },
        autoBranchCreationPatterns: { shape: 'Sq' },
    ...
    S25: { type: 'structure', required: ['prefix', 'branchName'], members: { prefix: {}, branchName: {} } },
    S28: {
      type: 'structure',
      required: [
      ...
      members: {
        ...
        subDomains: {
          ...
          member: {
            ...
            members: { subDomainSetting: { shape: 'S25' }, verified: { type: 'boolean' }, dnsRecord: {} }
          }
        }
      }
    },
...
AWS.apiLoader.services.sts['2011-06-15'] = {
  ...
  operations: {
    ...
    GetAccessKeyInfo: {
      ...
      output: { resultWrapper: 'GetAccessKeyInfoResult', type: 'structure', members: { Account: {} } }
    },
    GetCallerIdentity: {
  ...
  shapes: {
    ...
    Sh: {
      ...
      members: { AccessKeyId: {}, SecretAccessKey: {}, SessionToken: {}, Expiration: { type: 'timestamp' } }
    },
