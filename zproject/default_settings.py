...
SOCIAL_AUTH_COGNITO_KEY = get_secret('social_auth_cognito_key', development_only=True)
SOCIAL_AUTH_COGNITO_POOL_DOMAIN = get_secret('social_auth_cognito_pool_domain', development_only=True)
# SAML:
