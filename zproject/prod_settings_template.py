...
AUTHENTICATION_BACKENDS: Tuple[str, ...] = (
    ...
    # 'zproject.backends.AWSCognitoAuthBackend',  # AWS Cognito auth, setup below
...
# Configure the below settings by following the instructions here:
#
#     https://zulip.readthedocs.io/en/latest/production/authentication-methods.html#aws-cognito
#
